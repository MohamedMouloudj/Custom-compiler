...
public class MinINGParser extends Parser {
	...
	public static final int
		...
		GREATER=17, GREATEREQUAL=18, LESS=19, LESSEQUAL=20, EQUAL=21, NOTEQUAL=22, 
	...
	public static final int
		RULE_expression = 0, RULE_comparison = 1, RULE_decl = 2, RULE_table_decl = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"expression", "comparison", "decl", "table_decl"
		};
	}
	...
	public static class DeclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MinINGParserListener ) ((MinINGParserListener)listener).enterDecl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MinINGParserListener ) ((MinINGParserListener)listener).exitDecl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MinINGParserVisitor ) return ((MinINGParserVisitor<? extends T>)visitor).visitDecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Table_declContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MinINGParserListener ) ((MinINGParserListener)listener).enterTable_decl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MinINGParserListener ) ((MinINGParserListener)listener).exitTable_decl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MinINGParserVisitor ) return ((MinINGParserVisitor<? extends T>)visitor).visitTable_decl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Table_declContext table_decl() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_table_decl);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(56);
