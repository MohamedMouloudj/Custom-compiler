// Generated from src/main/java/com/customCompiler/MinINGLexer.g4 by ANTLR 4.13.2
...
public class MinINGLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"GREATEREQUAL", "LESS", "LESSEQUAL", "EQUAL", "NOTEQUAL", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "LBRACKET", "RBRACKET", "SEMI", "COMMA", "COMMENT", 
			"NEWLINE", "SPACE", "RECEIVE"
		};
	}
